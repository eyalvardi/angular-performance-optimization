...
import {auditTime, map, scan} from "rxjs/operators";
    ...
    template: `
        <div>
            ...
            <p>
                ...
                updates, meaning less expressions to calculate. The component is detached form the component tree and
                the update happens
...
export class OnDirtyDemoComponent extends BaseComponent {
    ...
    get auditTimeFeed() {
        return feed.source.pipe(auditTime(500));
    }
